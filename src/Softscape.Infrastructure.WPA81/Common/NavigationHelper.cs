...
using Softscape.Infrastructure.WPA81.MVVM;

namespace Softscape.Infrastructure.WPA81.Common
{
	/// <summary>
	...
	public class NavigationHelper : DependencyObject
	{
        ...
        {
			var abstractPage = Page as PortablePageWPA;
			if (abstractPage != null)
				abstractPage.OnBackKeyPress(e);
